...
typedef  struct  {
  ...
  boolean          executeModel[2]; //boolean *executeModel;
...
extern int treeReadTopologyString (const char *fp, tree *tr, boolean readBranches, boolean readNodeLabels, int *position, boolean topologyOnly, analdef *adef);
